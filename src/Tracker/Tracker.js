            ...
            <div className="flex">
                <div className="flex_content flex_form">
                    ...
                    <form onSubmit={(e) => { e.preventDefault(); addExpense(); }} className="form">
                        ...
                        <button className="btn btn_success" type="submit" style={{fontSize:'40px'}}>Add expense</button>
                        <button className="btn btn_danger" onClick={clearExpenses}>Clear record</button>
                        <button className="btn btn_primary" onClick={getCsv}>Save</button>
                    </form>
                </div>
